...
export function FollowedChannel({ channel }: Props) {
  return (
    <div
      ...
      className="flex gap-2 items-center px-4 py-2 h-[48px] border border-t-0 border-x-0 border-solid border-b-orange-300 border-opacity-50 hover:cursor-pointer"
    >
      <div>
        {channel.avatarUrl && (
